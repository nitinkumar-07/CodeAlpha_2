...
const TermsOfService = () => {
  return (
    <div className="bg-[#0a0b10] text-white">
      <div className="max-w-4xl mx-auto px-4 md:px-8 py-10">
        <h1 className="text-2xl md:text-3xl font-bold mb-6 text-center text-blue-600">Terms and Conditions</h1>
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-8 mb-4">2. Acceptance of Terms</h2>
        <p className="text-gray-400 leading-relaxed mb-4">
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-8 mb-4">3. Changes to Terms</h2>
        <p className="text-gray-400 leading-relaxed mb-4">
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-8 mb-4">6. Limitation of Liability</h2>
        <p className="text-gray-400 leading-relaxed mb-4">
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-8 mb-4">7. Governing Law</h2>
        <p className="text-gray-400 leading-relaxed mb-4">
        ...
        <h2 className="text-xl md:text-2xl font-semibold mt-8 mb-4">8. Contact Information</h2>
        <p className="text-gray-400 leading-relaxed mb-4">
